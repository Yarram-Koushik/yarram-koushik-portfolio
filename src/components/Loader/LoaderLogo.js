  ...
  render() {
    ...
    const css = `
      ...
      .signatureText {
        stroke-dasharray: 800;
        stroke-dashoffset: 800;
        -webkit-animation: dash 4s linear forwards 1.5s;
        animation: dash 4s linear forwards 1.5s;
      }
    ...
    return (
      ...
      >
        ...
        <path
          className="letter"
          d="M 178 95 H 188 V 115 L 203 95 H 215 L 198 120 L 216 145 H 204 L 188 125 V 145 H 178 Z"
          stroke={theme.body}
          strokeWidth="3"
        />
        <path
          className="letter"
          d="M 224 95 H 236 L 245 110 L 254 95 H 266 L 250 120 V 145 H 240 V 120 Z"
          stroke={theme.body}
          strokeWidth="3"
        />
